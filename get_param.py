# This python module contains the information to interact with the command line
...
def params():
	...
	parser.add_argument('--batch_size', default=10, type=int, help='batch size (default: 100)')
